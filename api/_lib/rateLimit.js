 ...
 * This is an anti-abuse throttle on top of the per-account free/Pro scan
 * limit enforced in the UI — it protects the shared Gemini API key from
 * being hammered, it does not replace the product-level limit.
 * @param {string} ip
